...
for i in range(1,21):
   ...
   clim_lat_hgt = zmzw_inst.climatology_lat_hgt(season)
...
ensemble_functions.plot_single_lat_hgt(ensdiff_feedback, ensmean_control, lat, hgt, 'Feedback (2075-2095) - Control (2010-2030),\n'+season, outdir+'U_ensdiff_feedback-control.png', 8, 1, 40, 5, r'U (ms$^{-1}$)', zsig=ttest_feedback)

# Plot ensemble mean difference RCP8.5-CONTROL
print "Plotting ensemble mean difference RCP8.5-CONTROL"
ensemble_functions.plot_single_lat_hgt(ensdiff_rcp85, ensmean_control, lat, hgt, 'RCP8.5 (2075-2095) - Control (2010-2030),\n'+season, outdir+'U_ensdiff_rcp85-control.png', 8, 1, 40, 5, r'U (ms$^{-1}$)', zsig=ttest_rcp85)

print "Plotting member differences FEEDBACK-CONTROL"
ensemble_functions.plot_matrix_lat_hgt(memdiff_feedback, ensmean_control, lat, hgt, 'Feedback (2075-2095) - Control (2010-2030), '+season, outdir+'U_memdiff_feedback-control_'+season+'.pdf', 8, 1, 40, 5, r'U (ms$^{-1}$)')

print "Plotting member differences RCP8.5-CONTROL"
ensemble_functions.plot_matrix_lat_hgt(memdiff_rcp85, ensmean_control, lat, hgt, 'RCP8.5 (2075-2095) - Control (2010-2030), '+season, outdir+'U_memdiff_rcp85-control_'+season+'.pdf', 8, 1, 40, 5, r'U (ms$^{-1}$)')
##********************************************************************************************************
#paths_feedback = []
#for i in range(1,21):
#   for j in range(2,10): 
