...
plot_functions.plot_single_lat_lon(ensdiff_geoheatS, season, outdir+var+'_ensdiff_geoheatS-control_'+season+'.png', 3.5, 0.5, 3.5, 0.5, 'hPa per 30 yrs', zsig=ttest_geoheatS)
