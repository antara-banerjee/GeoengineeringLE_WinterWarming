...
plot_functions.plot_single_lat_lon(ensdiff_feedback, ensdiff_feedback['lat'], ensdiff_feedback['lon'], '', outdir+'Ts_ensdiff_feedback-control_'+season+'.png', 3.6, 0.4, 3.6, 0.4, '$^{\circ}$C', zsig=ttest_feedback)
...
plot_functions.plot_single_lat_lon(ensdiff_geoheatS / 65.*30., ensdiff_geoheatS['lat'], ensdiff_geoheatS['lon'], '(b) Surface air temperature', outdir+'Ts_ensdiff_geoheatS-control_'+season+'.png', 2, 0.2, 2, 0.4, '$^{\circ}$C per 30 yrs', zsig=ttest_geoheatS)
'''
